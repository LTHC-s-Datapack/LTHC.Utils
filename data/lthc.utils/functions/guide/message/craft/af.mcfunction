...
tellraw @s ["",{"text":" \u0020In the LTHC Table:","color":"light_purple"},{"text":"\n \u0020 \u0020"},{"text":"A B C\n \u0020 \u0020D D D\n \u0020 \u0020D D D","color":"aqua"},{"text":"\n \u0020"},{"text":"A: Dropper, B: LTHC Table, C: Dragon Head, D: 4 Shulker Shell","color":"green"},{"text":"\n\n \u0020"},{"text":"[ < Back ]","color":"red","clickEvent":{"action":"run_command","value":"/function lthc.utils:guide/message/craft"}}]
